...
export default function MegaMenu({ categories }: MegaMenuProps) {
  ...
  return (
    <div className="bg-white border-t border-gray-200 shadow-sm sticky top-16 z-30">
            ...
            return (
              ...
              >
                ...
                {hasChildren && isHovered && (
                  <div className="absolute top-full left-0 w-screen max-w-5xl bg-white border border-gray-200 shadow-xl z-50 mt-0">
                        ...
                        {category.children?.map((subcategory) => (
                          <div key={subcategory.id} className="space-y-2">
                            <Link
                              ...
                              className="block font-semibold text-gray-900 hover:text-pink-600 transition-colors text-sm"
